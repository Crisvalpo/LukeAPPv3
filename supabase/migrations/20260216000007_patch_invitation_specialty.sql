-- Migration: Patch accept_invitation to support primary_specialty_id
-- Ensures that the specialty assigned during invitation is propagated to the member record.
...
BEGIN
  ...
  IF existing_member_id IS NOT NULL THEN
    ...
    SET 
      ...
      primary_specialty_id = inv_record.primary_specialty_id, -- NEW: Propagate specialty
      updated_at = now()
  ...
  ELSE
    ...
    INSERT INTO public.members (
      user_id, company_id, project_id, role_id, functional_role_id, job_title, primary_specialty_id, active
    ) VALUES (
      ...
      inv_record.primary_specialty_id, true -- NEW: Propagate specialty
    )
    RETURNING id INTO target_member_id;
  END IF;
